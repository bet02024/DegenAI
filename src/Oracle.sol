...
contract Oracle is Ownable {
    ...
    // Maximum price validity time (10 minutes by default)
    uint256 public maxPriceAge = 2400 hours; // 10 minutes
    ...
    /**
     * @dev Updates prices max age for the Oracle
     * @param _maxPriceAge price age in miliseconds
     */
    function updatePriceAge( uint256 _maxPriceAge ) external onlyOwner  {

...
import "../src/IDegenAiPool.sol";
import {console} from "forge-std/console.sol";


contract InvestmentTest is Test {

    address constant DEGENPOOL = 0xc79AB5D4544E50Db86061cF34908Ea42ADc2EDda;
    ...
    IDegenAiPool degenpoolContract;
    IERC20 stableCoin;
    ...
    function setUp() public {
        degenpoolContract = IDegenAiPool(DEGENPOOL);
        stableCoin = IERC20(USDC);
        vm.startPrank(USER);
        stableCoin.approve(address(DEGENPOOL), type(uint256).max);
        ...
        vm.stopPrank();
        console.log("UNI BALANCE", IERC20(UNISWAP_ADDRESS).balanceOf(DEGENPOOL)); 
        console.log("FTC BALANCE", IERC20(FTC_ADDRESS).balanceOf(DEGENPOOL)); 
        console.log("WBTC BALANCE", IERC20(WBTC_ADDRESS).balanceOf(DEGENPOOL)); 
    ...
    function testRebalance() public {
       ...
       // buyAmountsBps[1] = 5000;
        degenpoolContract.rebalance(sellAssets, sellAmountsBps, buyAssets, buyAmountsBps);
 ...
 /*
     ...
     function testInvest() public {
        vm.startPrank(USER);
        uint256 userBalace = degenpoolContract.userShares(USER);
        console.log("shares", userBalace);
        degenpoolContract.invest(2e6);
        console.log("shares", degenpoolContract.userShares(USER)); 
        vm.stopPrank();
    }
*/
  ...
  /*
    ...
    function testWithdraw() public {
        vm.startPrank(USER);
        degenpoolContract.withdraw(5000);
        vm.stopPrank();
    } 

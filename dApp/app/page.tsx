...
import { useDegenAiPool } from "@/hooks/useDegenAiPool"
      ...
      <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-gray-900 border-gray-800">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-white">Degen AI Pool</CardTitle>
    ...
    <div className="min-h-screen bg-black text-white p-4">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold">DegenAi Pool</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Invest USDC into the DegenAi Pool protocol</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
...
export default function DegenAiDApp() {
  return (
    <Suspense
      fallback={
